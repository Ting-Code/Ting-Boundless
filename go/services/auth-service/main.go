...
func main() {
	...
	mux.Handle("POST /internal/webhooks/logto",
		httpx.InternalAuth(internalToken)(http.HandlerFunc(handleLogtoWebhook)),
	)
...
func handleMiniProgramLogin(w http.ResponseWriter, r *http.Request) {
	rid := r.Header.Get("X-Request-Id")
	errs.Write(w, rid, errs.New(http.StatusNotImplemented, "not_implemented", "miniprogram login not implemented"))
}
